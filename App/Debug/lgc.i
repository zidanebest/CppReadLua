#line 1 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#line 11 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#pragma external_header(pop)
#line 13 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
#pragma external_header(push)
...
#pragma external_header(pop)
#line 14 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#line 17 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#line 19 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#line 20 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#line 21 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#line 22 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#line 26 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
#line 27 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
...
static int traversethread (global_State *g, lua_State *th) {
  ...
  if (o == ((void *)0))
    return 1;  
  ((void)0);
#line 630 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lgc.c"
  for (; o < th->top; o++)  
...
static void freeobj (lua_State *L, GCObject *o) {
  switch (o->tt) {
    ...
    case ((6) | ((0) << 4)): {
      ...
      luaM_free_(L, (cl), ((((int)((((size_t)&(((LClosure*)0)->upvals))))) + ((int)((sizeof(TValue *)))) * (cl->nupvalues))));
      break;
    }
    case ((6) | ((2) << 4)): {
      CClosure *cl = (&((((union GCUnion *)((o))))->cl.c));
      luaM_free_(L, (cl), ((((int)((((size_t)&(((CClosure*)0)->upvalue))))) + ((int)((sizeof(TValue)))) * (cl->nupvalues))));
      break;
    }
    case ((5) | ((0) << 4)):
    ...
    case ((7) | ((0) << 4)): {
      Udata *u = (&((((union GCUnion *)((o))))->u));
      luaM_free_(L, (o), ((((u->nuvalue) == 0 ? ((size_t)&(((Udata0*)0)->bindata)) : ((size_t)&(((Udata*)0)->uv)) + (sizeof(UValue) * (u->nuvalue))) + (u->len))));
      break;
    }
    case ((4) | ((0) << 4)): {
      TString *ts = (&((((union GCUnion *)((o))))->ts));
      luaS_remove(L, ts);  
      luaM_free_(L, (ts), ((((size_t)&(((TString*)0)->contents)) + ((ts->shrlen) + 1) * sizeof(char))));
      break;
    }
    case ((4) | ((1) << 4)): {
      TString *ts = (&((((union GCUnion *)((o))))->ts));
      luaM_free_(L, (ts), ((((size_t)&(((TString*)0)->contents)) + ((ts->u.lnglen) + 1) * sizeof(char))));
      break;
    }
    default: ((void)0);
  }
...
static void correctgraylists (global_State *g) {
  ...
  *list = g->allweak; g->allweak = ((void *)0);
  list = correctgraylist(list);
  *list = g->ephemeron; g->ephemeron = ((void *)0);
