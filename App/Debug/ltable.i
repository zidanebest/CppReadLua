#line 1 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 11 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#pragma external_header(pop)
#line 27 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
#pragma external_header(push)
...
#pragma warning(pop) 
#pragma external_header(pop)
#line 28 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 30 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 32 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 33 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 34 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 38 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 39 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 40 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 145 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
static Node *mainpositionTV (const Table *t, const TValue *key) {
  switch (((((key)->tt_)) & 0x3F)) {
    ...
    case ((2) | ((0) << 4)): {
      void *p = (((key)->value_).p);
      return ((&(t)->node[((((unsigned int)((size_t)(p) & 0xffffffff))) % ((((1<<((t)->lsizenode)))-1)|1))]));
    }
    case ((6) | ((1) << 4)): {
      lua_CFunction f = (((key)->value_).f);
      return ((&(t)->node[((((unsigned int)((size_t)(f) & 0xffffffff))) % ((((1<<((t)->lsizenode)))-1)|1))]));
    }
    default: {
      GCObject *o = (((key)->value_).gc);
      return ((&(t)->node[((((unsigned int)((size_t)(o) & 0xffffffff))) % ((((1<<((t)->lsizenode)))-1)|1))]));
    }
  }
}


static  Node *mainpositionfromnode (const Table *t, Node *nd) {
  TValue key;
  { TValue *io_=(&key); const Node *n_=(nd); io_->value_ = n_->u.key_val; io_->tt_ = n_->u.key_tt; ((void)((lua_State *)(((void *)0))), ((void)0)); };
...
#line 264 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
    size++;
    ((void)0);
    return size;
  }
...
static lua_Unsigned hash_search (Table *t, lua_Unsigned j) {
  ...
  do {
    i = j;  
    if (j <= ((lua_Unsigned)(9223372036854775807i64)) / 2)
      j *= 2;
    else {
      j = 9223372036854775807i64;
...
lua_Unsigned luaH_getn (Table *t) {
  ...
  ((void)0);
#line 962 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
...
#line 981 "D:\\CodeField\\C++\\新建文件夹\\CppReadyLua\\App\\src\\ltable.c"
