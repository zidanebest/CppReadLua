#line 1 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 11 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#pragma external_header(pop)
#line 12 "C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\Community\\VC\\Tools\\MSVC\\14.29.30133\\include\\setjmp.h"
...
#pragma warning(pop) 
#pragma external_header(pop)
#line 14 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
#pragma external_header(push)
...
__pragma(pack(pop))
#pragma external_header(pop)
#line 13 "C:\\Program Files (x86)\\Windows Kits\\10\\Include\\10.0.17763.0\\ucrt\\stdlib.h"
#pragma external_header(push)
...
#pragma external_header(pop)
#line 15 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
#pragma external_header(push)
...
#pragma external_header(pop)
#line 16 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 18 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 20 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 21 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 22 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 23 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 24 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 27 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
#line 1 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lparser.h"
...
#line 172 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lparser.h"
#line 28 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 30 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 31 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 33 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 34 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 64 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 71 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 78 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"

#line 80 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
#line 147 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
...
int luaD_reallocstack (lua_State *L, int newsize, int raiseerror) {
  int oldsize = ((int)(((L)->stack_last - (L)->stack)));
  int i;
  StkId newstack = (((StackValue *)(luaM_realloc_(L, ((void *)0), ((size_t)((0))) * sizeof(StackValue), ((size_t)((newsize + 5))) * sizeof(StackValue)))));
#line 196 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
  ((void)0);
  if ((newstack == ((void *)0))) {  
    if (raiseerror)
      luaD_throw(L, 4);
  ...
  i = ((oldsize <= newsize) ? oldsize : newsize) + 5;
  memcpy(newstack, L->stack, i * sizeof(StackValue));
  for (; i < newsize + 5; i++)
    (((&(newstack + i)->val))->tt_=(((0) | ((0) << 4)))); 
  correctstack(L, L->stack, newstack);
  luaM_free_(L, (L->stack), (oldsize + 5)*sizeof(*(L->stack)));
  L->stack = newstack;
...
void luaD_hook (lua_State *L, int event, int line,
  ...
  if (hook && L->allowhook) {  
    ...
    if ((!((ci)->callstatus & (1<<1))) && L->top < ci->top)
      L->top = ci->top;  
...
void luaD_poscall (lua_State *L, CallInfo *ci, int nres) {
  ...
  ((void)0);
#line 471 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\ldo.c"
  L->ci = ci->previous;  
}
 ...
 retry:
  switch ((((((&(func)->val))->tt_)) & 0x3F)) {
    ...
    case ((6) | ((0) << 4)): {  
      ...
      int i;
      if ((L->stack_last - L->top <= (fsize - delta))) { ptrdiff_t t__ = ((char *)(func) - (char *)L->stack); { if ((L->l_G)->GCdebt > 0) { (void)0; luaC_step(L); (void)0;}; ((void)0); }; luaD_growstack(L, fsize - delta, 1); func = ((StkId)((char *)L->stack + (t__))); } else { ((void)0); };
      ci->func -= delta;  
      for (i = 0; i < narg1; i++)  
...
static int finishpcallk (lua_State *L,  CallInfo *ci) {
  ...
  if ((status == 0))  
    ...
    StkId func = ((StkId)((char *)L->stack + (ci->u2.funcidx)));
    L->allowhook = ((ci->callstatus) & (1<<0));  
    luaF_close(L, func, status, 1);  
    func = ((StkId)((char *)L->stack + (ci->u2.funcidx)));  
...
static void finishCcall (lua_State *L, CallInfo *ci) {
  ...
  if (ci->callstatus & (1<<9)) {  
    ...
    { if (((-1)) <= (-1) && L->ci->top < L->top) L->ci->top = L->top; };  
    ((void) 0);
...
int luaD_closeprotected (lua_State *L, ptrdiff_t level, int status) {
  ...
  for (;;) {  
    struct CloseP pcl;
    pcl.level = ((StkId)((char *)L->stack + (level))); pcl.status = status;
...
int luaD_pcall (lua_State *L, Pfunc func, void *u,
  ...
  if ((status != 0)) {  
    ...
    luaD_seterrorobj(L, status, ((StkId)((char *)L->stack + (old_top))));
    luaD_shrinkstack(L);   
  }
