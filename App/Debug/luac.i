#line 1 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
...
#line 11 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
...
#pragma external_header(pop)
#line 13 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
#pragma external_header(push)
...
#pragma external_header(pop)
#line 14 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
#pragma external_header(push)
...
#pragma external_header(pop)
#line 15 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
#pragma external_header(push)
...
#pragma external_header(pop)
#line 16 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
#pragma external_header(push)
...
#pragma external_header(pop)
#line 17 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
...
#line 19 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
...
#line 20 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
...
#line 22 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
...
#line 24 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
#line 1 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lopnames.h"
...
#line 103 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\lopnames.h"

#line 25 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
...
#line 27 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
...
{
 fprintf((__acrt_iob_func(2)),"%s: %s\n",progname,message);
 exit(1);
}

static void cannot(const char* what)
{
 fprintf((__acrt_iob_func(2)),"%s: cannot %s %s: %s\n",progname,what,output,strerror((*_errno())));
 exit(1);
}
...
{
 if (*message=='-')
  fprintf((__acrt_iob_func(2)),"%s: unrecognized option '%s'\n",progname,message);
 else
  fprintf((__acrt_iob_func(2)),"%s: %s\n",progname,message);
...
{
 if (n==1)
  return ((((void)0), ((((void)0), (&((((union GCUnion *)(((((&(L->top+(-1))->val))->value_).gc))))->cl.l)))))->p);
 else
 {
  Proto* f;
  int i=n;
  if (lua_load(L,reader,&i,"=(" "luac" ")",((void *)0))!=0) fatal(lua_tolstring(L, (-1), ((void *)0)));
  f=((((void)0), ((((void)0), (&((((union GCUnion *)(((((&(L->top+(-1))->val))->value_).gc))))->cl.l)))))->p);
  for (i=0; i<n; i++)
  {
   f->p[i]=((((void)0), ((((void)0), (&((((union GCUnion *)(((((&(L->top+(i-n-1))->val))->value_).gc))))->cl.l)))))->p);
...
static int pmain(lua_State* L)
{
 ...
 if (dumping)
 {
  FILE* D= (output==((void *)0)) ? (__acrt_iob_func(1)) : fopen(output,"wb");
...
static void PrintConstant(const Proto* f, int i)
{
 ...
 switch (((((o)->tt_)) & 0x3F))
 {
  ...
  case ((3) | ((1) << 4)):
	{
	char buff[100];
	sprintf(buff,"%.14g",(((void)0), (((o)->value_).n)));
	printf("%s",buff);
	if (buff[strspn(buff,"-0123456789")]=='\0') printf(".0");
	break;
	}
  case ((3) | ((0) << 4)):
	printf("%" "ll" "d",(((void)0), (((o)->value_).i)));
	break;
  case ((4) | ((0) << 4)):
  case ((4) | ((1) << 4)):
	PrintString((((void)0), ((((void)0), (&((((union GCUnion *)((((o)->value_).gc))))->ts))))));
	break;
  default:				
	printf("?%d",((((o)->tt_)) & 0x3F));
	break;
...
static void PrintCode(const Proto* f)
{
 ...
 for (pc=0; pc<n; pc++)
 {
  ...
  int b=(((void)0), ((((int)((((i)>>((((0 + 7) + 8) + 1))) & ((~((~(Instruction)0)<<(8)))<<(0))))))));
  int c=(((void)0), ((((int)((((i)>>(((((0 + 7) + 8) + 1) + 8))) & ((~((~(Instruction)0)<<(8)))<<(0))))))));
  int ax=(((void)0), ((((int)((((i)>>((0 + 7))) & ((~((~(Instruction)0)<<(((8 + 8 + 1) + 8))))<<(0))))))));
  int bx=(((void)0), ((((int)((((i)>>(((0 + 7) + 8))) & ((~((~(Instruction)0)<<((8 + 8 + 1))))<<(0))))))));
  int sb=(((((void)0), ((((int)((((i)>>((((0 + 7) + 8) + 1))) & ((~((~(Instruction)0)<<(8)))<<(0))))))))) - (((1<<8)-1) >> 1));
  int sc=(((((void)0), ((((int)((((i)>>(((((0 + 7) + 8) + 1) + 8))) & ((~((~(Instruction)0)<<(8)))<<(0))))))))) - (((1<<8)-1) >> 1));
  int sbx=(((void)0), ((((int)((((i)>>(((0 + 7) + 8))) & ((~((~(Instruction)0)<<((8 + 8 + 1))))<<(0)))))) - (((1<<(8 + 8 + 1))-1)>>1)));
  int isk=(((void)0), ((((int)((((i)>>(((0 + 7) + 8))) & ((~((~(Instruction)0)<<(1)))<<(0))))))));
  ...
  switch (o)
  {
   ...
   case OP_LOADKX:
	printf("%d",a);
	printf("\t; "); PrintConstant(f,(((void)0), ((((int)((((code[pc+1])>>((0 + 7))) & ((~((~(Instruction)0)<<(((8 + 8 + 1) + 8))))<<(0)))))))));
	break;
   case OP_LOADFALSE:
	printf("%d",a);
	break;
   ...
   case OP_GETUPVAL:
	printf("%d %d",a,b);
	printf("\t; " "%s",((f->upvalues[b].name) ? ((f->upvalues[b].name)->contents) : "-"));
	break;
   case OP_SETUPVAL:
	printf("%d %d",a,b);
	printf("\t; " "%s",((f->upvalues[b].name) ? ((f->upvalues[b].name)->contents) : "-"));
   ...
   case OP_SETTABUP:
	...
	printf("\t; " "%s",((f->upvalues[a].name) ? ((f->upvalues[a].name)->contents) : "-"));
   ...
   case OP_NEWTABLE:
	printf("%d %d %d",a,b,c);
	printf("\t; " "%d",c+((((void)0), ((((int)((((code[pc+1])>>((0 + 7))) & ((~((~(Instruction)0)<<(((8 + 8 + 1) + 8))))<<(0))))))))*(((1<<8)-1)+1)));
	break;
   case OP_SELF:
	printf("%d %d %d%s",a,b,c,(isk ? "k" : ""));
	if (isk) { printf("\t; "); PrintConstant(f,c); }
   ...
   case OP_MMBINK:
	...
	printf("\t; " "%s ",(((tmname[c])->contents))); PrintConstant(f,b);
	if (isk) printf(" flip");
	break;
   case OP_UNM:
	printf("%d %d",a,b);
   ...
   case OP_TBC:
	...
	break;
   case OP_JMP:
	printf("%d",(((void)0), ((((int)((((i)>>((0 + 7))) & ((~((~(Instruction)0)<<(((8 + 8 + 1) + 8))))<<(0)))))) - (((1 << ((8 + 8 + 1) + 8)) - 1) >> 1))));
	printf("\t; " "to %d",(((void)0), ((((int)((((i)>>((0 + 7))) & ((~((~(Instruction)0)<<(((8 + 8 + 1) + 8))))<<(0)))))) - (((1 << ((8 + 8 + 1) + 8)) - 1) >> 1)))+pc+2);
	break;
   case OP_EQ:
   ...
   case OP_SETLIST:
	printf("%d %d %d",a,b,c);
	if (isk) printf("\t; " "%d",c+((((void)0), ((((int)((((code[pc+1])>>((0 + 7))) & ((~((~(Instruction)0)<<(((8 + 8 + 1) + 8))))<<(0))))))))*(((1<<8)-1)+1)));
	break;
   case OP_CLOSURE:
	printf("%d %d",a,bx);
...
#line 661 "D:\\Project\\Project\\C++\\CppReadyLua\\App\\src\\luac.c"
  }
  printf("\n");
 }
}
...
static void PrintDebug(const Proto* f)
{
 ...
 {
  printf("\t%d\t%s\t%d\t%d\n",
  i,((f->locvars[i].varname)->contents),f->locvars[i].startpc+1,f->locvars[i].endpc+1);
 }
 n=f->sizeupvalues;
 ...
 {
  printf("\t%d\t%s\t%d\t%d\n",
  i,((f->upvalues[i].name) ? ((f->upvalues[i].name)->contents) : "-"),f->upvalues[i].instack,f->upvalues[i].idx);
 }
}
