...
CClosure *luaF_newCclosure (lua_State *L, int nupvals) {
  GCObject *o = luaC_newobj(L, ((6) | ((2) << 4)), (((int)((((size_t)&(((CClosure*)0)->upvalue))))) + ((int)((sizeof(TValue)))) * (nupvals)));
...
LClosure *luaF_newLclosure (lua_State *L, int nupvals) {
  GCObject *o = luaC_newobj(L, ((6) | ((0) << 4)), (((int)((((size_t)&(((LClosure*)0)->upvals))))) + ((int)((sizeof(TValue *)))) * (nupvals)));
...
void luaF_newtbcupval (lua_State *L, StkId level) {
  ...
  while (((unsigned int)((level - L->tbclist))) > ((256ul << ((sizeof(L->stack->tbclist.delta) - 1) * 8)) - 1)) {
    L->tbclist += ((256ul << ((sizeof(L->stack->tbclist.delta) - 1) * 8)) - 1);  
    L->tbclist->tbclist.delta = 0;
  }
  level->tbclist.delta = ((unsigned short)(level - L->tbclist));
  L->tbclist = level;
}
...
void luaF_closeupval (lua_State *L, StkId level) {
  UpVal *uv;
  StkId upl;  
  while ((uv = L->openupval) != ((void *)0) && (upl = (((StkId)((uv)->v)))) >= level) {
...
static void poptbclist (lua_State *L) {
  ...
  while (tbc > L->stack && tbc->tbclist.delta == 0)
    tbc -= ((256ul << ((sizeof(L->stack->tbclist.delta) - 1) * 8)) - 1);  
  L->tbclist = tbc;
}
